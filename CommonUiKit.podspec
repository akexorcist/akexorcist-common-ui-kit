...
Pod::Spec.new do |s|
  s.name             = 'CommonUiKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CommonUiKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Akexorcist/CommonUiKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Akexorcist' => 'akexorcist@gmail.com' }
  s.source           = { :git => 'https://github.com/Akexorcist/CommonUiKit.git', :tag => s.version.to_s }
